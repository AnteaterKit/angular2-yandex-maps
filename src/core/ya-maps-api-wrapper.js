...
var YaMapsAPIWrapper = (function () {
    ...
    YaMapsAPIWrapper.prototype.createMap = function (el, mapOptions) {
        ...
        return this._loader.load().then(function () {
            var map = new yandex.maps.Map(el, mapOptions);
    ...
    YaMapsAPIWrapper = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof ya_maps_loader_1.YaMapsAPILoader !== 'undefined' && ya_maps_loader_1.YaMapsAPILoader) === 'function' && _a) || Object, core_1.NgZone])
    ], YaMapsAPIWrapper);
